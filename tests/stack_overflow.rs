...
fn stack_overflow() {
    stack_overflow();
    volatile::Volatile::new(0).read(); // Prevent tail recursion optimization(ransform a function whose last statement is a recursive function call into a normal loop.)
}
